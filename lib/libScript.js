...
// Google Chart API
  	...
  	var chart=null;
		...
		drawChart=()=>{ // bug: xong data thi sua chart voi nolegend
			if(!chartApiReady){console.warn('chartApi is not ready');return;}
			var dataArray=[['Tình trạng', 'Số lượng'],['Đang thực hiện', 15],['Đang chờ duyệt', 1],['Hoàn thành', 4],['Quá hạn', 1],['Tạm dừng', 1]];
...
// description="Materialize Init"
  ...
  initScriptUI=()=>{logF(initMainUI);logF(initSideBar);logF(initDulieuUI);}
//=================================================
